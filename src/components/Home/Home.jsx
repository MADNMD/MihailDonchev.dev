...
export const Home = () => {
    ...
    return (
        <div className="font-mono text-green-400 p-6">
            ...
            <motion.div className="ml-8 mt-2 mb-2"
                ...
                <motion.div className="ml-8 mt-2 mb-2"
                    ...
                    <motion.div className="ml-8"
                        ...
                        <p className='text-2xl bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent'>
                           {text('home.p')}
                        </p>
                    </motion.div>
                    <p className="text-form-logo-text font-custom-2">&lt;/p&gt;</p>
